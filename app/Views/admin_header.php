...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('template/assets/vendors/owl-carousel-2/owl.carousel.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('template/assets/vendors/owl-carousel-2/owl.theme.default.min.css') ?>">
